...
class RepayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_repay, container, false)

        val amount = root.findViewById<TextInputEditText>(R.id.amount)
        val btnRepay = root.findViewById<MaterialButton>(R.id.btnRepay)

        btnRepay.setOnClickListener {
            AlertDialog.Builder(requireContext()).setTitle("Borrow")
                .setMessage("You are repaying Your debt of UGX 500000. \n Enter Your pin to confirm.")
